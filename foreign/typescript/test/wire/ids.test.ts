...
void test("given_distinct_wire_id_kinds_when_encoded_then_should_not_be_interchangeable", () => {
  ...
  // A type-level check: this line intentionally does not compile if uncommented,
  // proving RecordId and ChannelId are distinct nominal types.
  // const wrong: RecordId = channel
})
