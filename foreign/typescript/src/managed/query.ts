...
export class QueryRequest {
  ...
  /** Match an indexed key exactly, the cheap path a projection's key columns
   * serve directly. Named `where_eq` in the Rust and Python SDKs. */
  ...
  /** The former spelling of `whereEq`, kept so existing callers keep compiling.
   * Prefer `whereEq`, which matches the other SDKs. */
