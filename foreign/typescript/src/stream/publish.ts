...
export class PublishRequest {
  ...
  json<T>(value: T, codec?: Codec<T>): this {
    if (codec === undefined) return this.encodeWith<unknown>(value, identityJson, ContentType.Json)
  ...
  msgpack<T>(value: T, codec?: Codec<T>): this {
    if (codec === undefined) {
      return this.encodeWith<unknown>(value, identityMessagePack, ContentType.Msgpack)
    }
...
export class BatchPublishRequest {
  ...
  addJson(value: unknown): this
  addJson<T>(value: T, codec: Codec<T>): this
  addJson<T>(value: T, codec?: Codec<T>): this {
    if (codec === undefined) return this.addEncoded<unknown>(value, identityJson, ContentType.Json)
  ...
  addMsgpack<T>(value: T, codec?: Codec<T>): this {
    if (codec === undefined) {
      return this.addEncoded<unknown>(value, identityMessagePack, ContentType.Msgpack)
    }
  ...
  extendJson(values: Iterable<unknown>): this
  extendJson<T>(values: Iterable<T>, codec: Codec<T>): this
  extendJson<T>(values: Iterable<T>, codec?: Codec<T>): this {
    if (codec === undefined) {
      return this.extendEncoded<unknown>(values, identityJson, ContentType.Json)
    }
