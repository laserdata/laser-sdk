...
class KeyRecord:
    ...
    def kind(self) -> builtins.str: ...
    @property
    def valid_from_micros(self) -> builtins.int: ...
    @property
...
class OpVersions:
    ...
    """
    @property
    def query(self) -> builtins.int: ...
    @property
    def control(self) -> builtins.int: ...
    @property
    def kv(self) -> builtins.int: ...
    @property
    def fork(self) -> builtins.int: ...
    @property
    def agent(self) -> builtins.int: ...
    @property
