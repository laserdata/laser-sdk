...
fn given_managed_command_codes_when_compared_then_should_match_the_dictionary() {
    ...
    assert_eq!(AGDX_GET_SCHEMA_CODE, 1_000_120);
    assert_eq!(AGDX_LIST_SCHEMAS_CODE, 1_000_121);
    assert_eq!(AGDX_REGISTER_SCHEMA_CODE, 1_000_122);
    assert_eq!(AGDX_DECODE_RECORD_CODE, 1_000_123);
    assert_eq!(AGDX_KV_BASE, 1_000_200);
    assert_eq!(AGDX_KV_GET_CODE, 1_000_200);
    assert_eq!(AGDX_KV_SET_CODE, 1_000_201);
    assert_eq!(AGDX_KV_SCAN_CODE, 1_000_202);
    assert_eq!(AGDX_KV_DELETE_CODE, 1_000_203);
...
fn given_result_codes_when_compared_then_should_match_the_dictionary() {
    ...
    assert_eq!(ResultCode::Unauthorized.code(), 8);
