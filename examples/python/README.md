...
| [`kv.py`](kv.py) | State | set/get keyed JSON with a TTL, upgrade it under compare-and-swap, write and promote a fork row | yes | [`/laser-sdk/state`](https://docs.laserdata.cloud/laser-sdk/state) |
