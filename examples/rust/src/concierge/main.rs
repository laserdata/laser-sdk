...
use laser_examples::{
    LlmClient, PARTITIONS, batch, cloud_feature_ready, default_llm, env_bool, init_tracing, laser,
...
async fn main() -> Result<(), LaserError> {
    ...
    if !cloud_feature_ready(capabilities.managed, "the agentic desk", "concierge") {
        return Ok(());
    }
