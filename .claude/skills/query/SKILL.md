...
Wire types use named fields. Every shipped operation surface remains version 1 throughout the pre-1.0 package line. A breaking contract change replaces its consumers, fixtures, and implementations together rather than preserving an older shape or assigning a migration version.
